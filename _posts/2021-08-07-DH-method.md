...
\cos(\theta) p_x +\sin(\theta) p_y + y_{\rm shift} \\
\end{bmatrix}
...
\cos(\theta) \cdot p_x +\sin(\theta) \cdot p_y + y_{\rm shift} \cdot 1 \\
...
\cos(\theta_1) & \sin(\theta_1)  & y_{\rm s1} \\
0 & 0 & 1\\
\end{bmatrix}\\
...
\cos(\theta_2) & \sin(\theta_2)  & y_{\rm s2} \\
0 & 0 & 1\\
\end{bmatrix}\\
